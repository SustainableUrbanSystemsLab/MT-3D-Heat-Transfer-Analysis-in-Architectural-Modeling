...
\begin{figure}[h!]
    ...
    \todo{make sure all a, b captions have this consistant order. currently they dont.}
\end{figure}
...
\begin{figure}[htb]
   ...
   \label{meshsteps}
 \end{figure}
\todo{is there any way you can combine figure 4.1 and 4.9, into an a), and b) figure? Would it make sense?}
