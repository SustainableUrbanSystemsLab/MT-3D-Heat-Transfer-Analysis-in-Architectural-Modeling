...
\todo{make sure OF is either in italics everywhere or nowhere}
...
The validation case was constructed in \textit{ \gls{OF}}\todo{check if you want italics or not? Please either all software in italics or not italics} by creating the mesh and \textit{snappyHexMesh} files.  
...
Where \( h \) is the specific enthalpy, \( \rho \) is the density, and \( \alpha = \frac{\kappa}{c_p} \) is the thermal diffusivity, and the specific heat capacity \( c_p \) \todo{this was spelled as capital in the chapter before, please make consistent}. 
...
The fvOptions text file allows the user to further manipulate the systems of equations, such as sources and sinks.  \todo{do not think this is true, please double-check!!!}
...
\todo{don't call these approaches, call them solutions. "can be solved"}
...
\todo{add the version of Quickfield that you used here. was is the free version? what is it called exactly?}
...
\subsection{Additional Potential}\todo{call this differently, this sounds weird}
