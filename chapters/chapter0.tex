...
\todo{reword}
\begin{itemize}
    \item The architectural field lacks the workflows to simulate 3D heat transfer. \todo{not true, say what it exactly lacks.} The automation of writing the OF text files reduces tremendous effort and time
...
\subsection{Relevance in Practice}
\todo{reword}
\begin{itemize}
...
\begin{itemize}
    ...
    \todo{this is a bit all over the place. Please consolidate}
\end{itemize}
